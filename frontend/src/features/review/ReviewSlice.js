...
export const deleteReviewByIdAsync = createAsyncThunk(
  "reviews/deleteReviewByIdAsync",
  async (id) => {
...
export const selectReviewErrors = (state) => state.review.errors;
export const selectReviewSuccessMessage = (state) =>
  state.review.successMessage;
export const selectReviewAddStatus = (state) => state.review.reviewAddStatus;
export const selectReviewDeleteStatus = (state) =>
  state.review.reviewDeleteStatus;
export const selectReviewUpdateStatus = (state) =>
  state.review.reviewUpdateStatus;
export const selectReviewFetchStatus = (state) =>
  state.review.reviewFetchStatus;
