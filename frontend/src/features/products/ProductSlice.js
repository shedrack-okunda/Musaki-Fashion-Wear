...
export const selectProductTotalResults = (state) => state.product.totalResults;
export const selectSelectedProduct = (state) => state.product.selectedProduct;
export const selectProductErrors = (state) => state.product.errors;
export const selectProductSuccessMessage = (state) =>
  state.product.successMessage;
export const selectProductUpdateStatus = (state) =>
  state.product.productUpdateStatus;
export const selectProductAddStatus = (state) => state.product.productAddStatus;
export const selectProductIsFilterOpen = (state) => state.product.isFilterOpen;
export const selectProductFetchStatus = (state) =>
  state.product.productFetchStatus;
